...
Cat::Cat( const boost::filesystem::path& basePath, uint32_t catNum, const std::string& name ) :
   m_name( name ),
   m_catNum( catNum ),
   m_chunk( -1 )
{
...
Cat::Cat( const boost::filesystem::path& basePath, uint32_t catNum, const std::string& name, uint32_t exNum, uint32_t chunk ) :
   m_name( name ),
   m_catNum( catNum ),
   m_chunk( chunk )
{
